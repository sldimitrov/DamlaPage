...
export default function InputForm({ handleSubmit, setError }) {
  ...
  const labelClass =
    "text-white sm:text-center text-left text-base md:text-2xl font-serif pl-3 lg:text-left";
  const inputClass =
  ...
  return (
    <div id="contact-form" className="form flex flex-col mx-auto w-10/12">
      <h2 className="text-white mt-4 text-2xl font-semibold md:text-4xl font-mono text-center mb-4">
        Свържи се с aвтора
      </h2>
